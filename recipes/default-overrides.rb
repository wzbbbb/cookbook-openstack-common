...
node.override["openstack"]["network"]["ml2"]["local_ip_interface"] = "eth0"
#node.override['openstack']['network']['openvswitch']['local_ip_interface'] = "eth1" 
# L3 external bridge binding
node.override["openstack"]["network"]["l3"]["external_network_bridge_interface"] = "eth0"
# Openvswitch 
node.override["openstack"]["network"]["openvswitch"]["local_ip_interface"] = "eth0"
